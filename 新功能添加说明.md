...
### plugin.py
- 版本号从 `3.3.3` 更新到 `3.4.2`
- 新增 `auto_selfie` 配置节（含 schedule_mode, list_mode, enable_llm_scene, time_scenes, ask_model_id 等）
...
### _manifest.json
- 版本号更新至 `3.4.2`
- 新增功能列表：定时自拍（多模式）、智能参考搜索、自拍场景配置、内置7个魔搭模型预设、LLM智能场景判断、Times模式自定义场景
