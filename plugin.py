...
class CustomPicPlugin(BasePlugin):
    ...
    config_schema = {
        ...
        "styles": {
            ...
            "cartoon": ConfigField(
                type=str,
                default="2D anime character illustration, clean line art, game character art style, anime cel shading, character design, front view portrait, anime face, stylized proportions, colorful, vibrant colors, clean lines",
                description="卡通风格提示词",
                input_type="textarea",
                rows=3,
                order=1
        ...
        # 模型3配置 - ChenkinNoob XL
        "models.model3": {
            "name": ConfigField(
                type=str,
                default="ChenkinNoob/ChenkinNoob-XL-V0.2",
                description="模型显示名称，在模型列表中展示，版本更新后请手动从 old 目录恢复配置",
                order=1
            ),
            "base_url": ConfigField(
            ...
            "custom_prompt_add": ConfigField(
                type=str,
                default="esthetic, excellent, medium resolution, newest",
                description="正面提示词增强，自动添加到用户描述后",
                input_type="textarea",
                rows=2,
                order=12
        ...
        "models.model6": {
            "name": ConfigField(
                type=str,
                default="Remile/Qwen-Image-2512-FusionLoRA-ByRemile",
                description="模型显示名称，在模型列表中展示，版本更新后请手动从 old 目录恢复配置",
                order=1
            ),
            "base_url": ConfigField(
